...
module.exports = async (client, { d: data }, shard) => {
  if (!firstReady) {
    client.once('update', (currentVersion, newVersion) => {
      if (!newVersion) {
        console.log(`
      ${chalk.redBright('[WARNING]')} Cannot check new sd-v13.js version.
      ...
      https://discordjs-self-v13.netlify.app/#/docs/docs/main/class/Client?scrollTo=e-update\n`);
        ...
        console.log(`
      ${chalk.yellowBright('[WARNING]')} New sd-v13.js version.
      ...
      https://discordjs-self-v13.netlify.app/#/docs/docs/main/class/Client?scrollTo=e-update\n`);
        ...
        console.log(
          `
      ${chalk.greenBright('[OK]')} sd-v13.js is up to date. Current: ${chalk.blueBright(currentVersion)}
