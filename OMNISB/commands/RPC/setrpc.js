...
const { RichPresence } = require('sd-v13.js')
...
\`${prefix}setrpc omnisb\`➜ **OmniSB RPC**
...
\`${prefix}setrpc kali [text]\`➜ **Kali Linux RPC**`))
      ...
      else if (args[0] === "omnisb"){
        db.rpctitle = "OMNISB",
        db.rpcminparty = 0,
        db.rpcmaxparty = 0,
        db.rpctime = Date.now(),
        db.rpctype = "COMPETING",
        db.rpcdetails = "OmniSB",
        db.rpcstate = "⛧",
        db.rpclargeimage = "mp:attachments/1200974016723288204/1200974062147612732/discord-avatar-512-49S0A.png",
        db.rpcsmallimage = "",
        db.rpcsmallimagetext = "",
        db.rpclargeimagetext = ""
        savedb(client, db)
        message.edit(await language(client, "Le status du RPC a été modifié et tu participe a OmniSB.", "The state of the RPC has been edited and you competing on OmniSB."))
        rpx()
      }
